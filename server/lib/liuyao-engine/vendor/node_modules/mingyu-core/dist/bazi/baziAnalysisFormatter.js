...
function buildBaziText(baziResult, options) {
    ...
    const { includeRules = true, includeShensha = true, includeShenShaAnalysis = false, includeWuxing = true, includeLuckOverview = true, } = options;
    let result = '【命盘】\n';
