...
import { formatEnhancedDivinationInfo } from './divination-enhanced.js';
...
export function formatSupplementaryInfo(info, _method) {
    if (!info)
        return '';
    return [
...
export function buildDivinationPromptDocument(options) {
    ...
    const task = options.method === 'astrolabe'
