...
const PRODUCTS = {
  red_agate: {
    ...
    price_usd: 9.90,
    tagline: '补火气·招财运·挡小人',
    description: '经寺院诵经开光，红玛瑙属火，主热情与财运，适合五行缺火或流年财运偏弱者。',
  ...
  black_obsidian: {
    ...
    price_usd: 12.90,
    tagline: '辟邪护身·挡煞气·守财',
    description: '貔貅为招财神兽，黑曜石辟邪化煞，经高僧开光加持，护身效果最强，适合风马偏低或命格中有煞星者。',
  ...
  yellow_crystal: {
    ...
    price_usd: 11.90,
    tagline: '旺财运·补土气·聚能量',
    description: '黄水晶属土，对应财帛宫，经寺院开光后能量倍增，适合五行缺土、财库薄弱或吠陀木星力量不足者。',
  ...
  green_phantom: {
    ...
    price_usd: 18.90,
    tagline: '旺事业·补木气·助升职',
    description: '绿幽灵属木，主生长与事业，内含天然矿物层叠如山峦，适合五行缺木、事业停滞或需要突破瓶颈者。',
  ...
  white_crystal: {
    ...
    price_usd: 8.90,
    tagline: '补金气·净气场·增智慧',
    description: '白水晶至纯至净，属金，能放大正向能量、净化气场，适合五行缺金、思维混乱或需要增强洞察力者。',
  ...
  tibetan_bracelet: {
    ...
    price: 98,
    price_usd: 14.90,
    tagline: '提升风马·藏传加持·全方位守护',
    description: '五色代表藏传五大元素（白/蓝/黄/红/绿），由藏族喇嘛诵经加持，专为提升风马（Lungta）能量设计，适合藏历命理中风马偏低或元素失衡者。',
