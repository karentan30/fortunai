...
③不写荒诞仪式，择日只对TA明确说过要做的事。④全文一个百分号(%)都不许出现（事实卡元素数值除外）。⑤绝不虚构研究、论文、数据来源或权威出处（如"数据来自2025年《占星与神经科学》研究"），命理解读不得伪装成科研统计。${FMT_LAW_ZH}`;
