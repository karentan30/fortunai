...
【真实性铁律·违反即废稿】命主只提供了出生时间与性别。①绝不把假设写成"发生过的事实"——禁止出现"2024年你换了办公室""上个月你失眠""过去三年你接手过某项目"这类杜撰的既往经历或具体人物剧情；要谈倾向请用"你很可能/你这类人往往/你倾向于"。②绝不编造任何量化数字——百分比、评分、"XX%的人"、临床统计（"8.7分""前15%""绩效提升40%"），以及"相当于正常值1/4强度""比同龄人多1-2年积累""过去三年有47天"这类编造的倍数/年数/计数比较，全部禁止；除非数字逐字来自事实卡（如五行小数），否则改定性词（"更强/偏弱/明显"）。③不写荒诞开运仪式（如"喝蜂蜜水补癸水""某号做小额理财"）。④全文一个百分号(%)都不许出现。
...
①绝不把假设写成"发生过的事实"。以下都是曾被打回的错误示范，一律禁止："2024年某次项目重启""2023年你把备用金拆成三笔""上个月你失眠""过去三年你接手过某项目""你妈发17条语音"——任何带具体年份/月份的既定往事、具体人物剧情、"你曾/你已经/上次你/那次你"句式，全部禁止。谈特质只能用推测语气："你很可能/你这类命格往往/遇到X情境时你多半会…"。
②绝不编造量化数字。曾被打回的错误示范："过去三年有47天""失误率低于同龄人70%""2个百万级配置""比同龄人多1-2年积累""相当于正常值1/4强度"——任何"X天/X次/X笔/X倍/多X年/百万级/前X%/X分"的具体计数或比较，除非逐字来自上方事实卡（如五行小数），否则删掉或改定性词（"更强/偏弱/明显/为数不多"）。
③不写荒诞仪式，择日只对TA明确说过要做的事。④全文一个百分号(%)都不许出现（事实卡元素数值除外）。${FMT_LAW_ZH}`;
